...
export const WORK_EXPERIENCE = [
  {
    ...
    duties: [
      "Improved company efficiency by developing applications for internal use.",
      "Digitized New Hire & Position Change forms by devising form management web-app using React and NoSQL.",
...
export const SKILLS = {
  ...
  Intermediate: ["Python", "Java", "MySQL", "jQuery","Node.js"],
